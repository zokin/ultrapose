...
parser = argparse.ArgumentParser(description='Ultrapose inference.')
parser.add_argument('--checkpoint', type=str,
    default='checkpoints/transUltra.pth', 
...
if __name__ == '__main__':
    ...
    image_dir = 'D:\\Data\\ultrapose\\val2014'
    ann_path = 'D:\\Data\\ultrapose\\annotations\\densepose_valminusminival2014.json'
